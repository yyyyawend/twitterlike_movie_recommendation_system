...
import { FilmIcon, PlayIcon, SearchIcon, ShoppingCartIcon } from '@heroicons/react/outline';
        ...
        <div className="sticky top-0 z-50 flex items-center p-2 lg:px-5 shadow-md">
            ...
            <div className="flex justify-center flex-grow">
                <div className="flex space-x-3 md:space-x-2">
                    <HeaderIcon active={window.location.pathname==="/" ? true : false} Icon={HomeIcon} url="/" />
                    <HeaderIcon active={window.location.pathname==="/movies" ? true : false} Icon={FilmIcon} url="/movies" />
