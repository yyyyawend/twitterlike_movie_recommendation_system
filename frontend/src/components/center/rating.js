...
function Rating(props) {
  ...
  const [vote_average, setVote_average] = useState(props.vote_average);
        ...
        fetch('http://127.0.0.1:8000/api/rating', {
          ...
          .then(res => {
            if (res.data.id) {
              ...
              setHover(null);
              setErrors(false);
              setVote_average(res.vote_average)
            } else {
              setRating(null);
              setHover(null);
              setErrors(true);
                  ...
                  <div className="bg-white p-6 pb-4 ">
                    <div className="flex items-center justify-center">
                      <div className="text-center ml-4">
                        ...
                        {errors !== false && <h2>There was an error, please try again!</h2>}
                        <div className="p-6 text-center">
                          ...
                          <div className="mt-6 space-x-5">
                            <button
                              type="button"
                              className="text-white bg-orange-600 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 dark:focus:ring-orange-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"
